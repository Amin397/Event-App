...
class ImageClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.2, size.height * 0.85, curveEndingPoint.dx - 60, curveEndingPoint.dy + 10);
    path.quadraticBezierTo(size.width * 0.99, size.height * 0.99, curveEndingPoint.dx, curveEndingPoint.dy);
